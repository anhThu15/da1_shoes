        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">User <a href="?mod=admin&act=account_add"  class="btn btn-sm btn-success"><i class="fa-solid fa-user-plus"></i></a></h3>
                    ...
                    <th scope="row">
                      <div class="media align-items-center">
                        <a href="#" class="avatar rounded-circle mr-3">
                          <img alt="Image placeholder" src="upload/avatar/<?= $item['user_img'] ?>">
                        </a>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="?mod=admin&act=account_edit&id=<?= $item['user_id']  ?>">EDIT</a>
                          <a class="dropdown-item" href="?mod=admin&act=ur_admin_del&id=<?= $item['user_id']  ?>">DELETE</a>
                        </div>
                      </div>
                    </td>
                  </tr>
