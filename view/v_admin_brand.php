        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">Brand <a href="?mod=admin&act=brand_add" name="submit" class="btn btn-sm btn-success"><i class="fa-solid fa-plus"></i></a></h3>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <tr>
                    <th scope="row">
                      <div class="media align-items-center">
                        <div class="media-body">
                          <span class="mb-0 text-sm"><?= $item['brand_name'] ?></span>
                        </div>
                      </div>
                    </th>
                    ...
                    <td>
                      <span class=" mr-4">
                        <i class="bg-warning"></i> <?= $item['brand_day'] ?>
                      </span>
                    </td>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="?mod=admin&act=brand_edit&id=<?= $item['brand_id'] ?>">EDIT</a>
                          <a class="dropdown-item" href="?mod=admin&act=brand_del&id=<?= $item['brand_id'] ?>">DELETE</a>
                        </div>
                      </div>
                    </td>
                  </tr>
