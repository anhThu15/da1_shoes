                          ...
                          <div class="row">
                            <div class="col-lg-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="fullname" class="form-control form-control-alternative" placeholder="Full name">
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" >Username</label>
                                <input type="text"  name="name" class="form-control form-control-alternative" placeholder="Username"  >
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            ...
                            <div class="col-lg-6">
                              <div class="form-group">
                                ...
                                <input type="text"  name="pass" class="form-control form-control-alternative" placeholder="Password" >
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="text" name="address" class="form-control form-control-alternative" placeholder="Address" >
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="pl-lg-4">
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <select class="form-select form-control form-control-alternative" name="permission" aria-label="Default select example">
