                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input class="form-control form-control-alternative" name="name" type="text" placeholder="Brand Name" value="<?=$idBr['brand_name'] ?>">
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="text" name="description" class="form-control form-control-alternative" placeholder="DescriptionText"  value="<?=$idBr['brand_description'] ?>">
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="pl-lg-4">
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <input type="date" name="day" class="form-control form-control-alternative" placeholder="Day" value="<?=$idBr['brand_day'] ?>"> 
                              </div>
                            </div>
                          </div>
                        </div>
